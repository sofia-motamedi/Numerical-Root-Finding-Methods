...
def false_position(f, a, b, tol, n, v0, theta, g):
    if f(a, v0, theta, g) * f(b, v0, theta, g) >= 0:
        raise ValueError(
            "False Position method requires opposite signs at the interval endpoints."
        )
...
initial_guess_2 = 50
R_B = bisection(
    f, a, b, tol, v0, theta, g
)

R_F = false_position(
    f, a, b, tol, n, v0, theta, g
)

R_N = newton_raphson(
    f, f_derivative, initial_guess, tol, n,
    v0, theta, g
)

R_Se = secant_method(
    f, initial_guess_1, initial_guess_2,
    tol, n, v0, theta, g
)

R_Su = successive_approximation(
    initial_guess, tol, n, v0, theta, g
)
